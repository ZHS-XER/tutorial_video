...
//    → 双击建 Text / Seedance → 逐条连线 → Run All → 切到跑完的素材项目，视频在节点里播放 → 小结。
...
import { edgeDraw, injectNodePreview, nodeRunning, nodeGlow } from '@youart/drivesFlow';
...
const DV = P0 + 's2-dblvideo', DVS = P0 + 's2-dblvideosearch', VN = P0 + 's2-videonode', E2 = P0 + 's2-edge2', E3 = P0 + 's2-edge3', BU = P0 + 's2-built', MB = P0 + 'm-built';
export const S2_SLOTS = [N2, E1, EH, DEL, PF, PR, DT, DTS, TN, TF, TFI, DV, DVS, VN, E2, E3, BU, MB];
const IDS = ['s2-1', 's2-2', 's2-3', 's2-4', 's2-5', 's2-6', 's2-7', 's2-8', 's2-9', 's2-10', 's2-11', 's2-12', 's2-13', 's2-14', 's2-15'];
...
const { t, end } = seqLines(IDS, { gap: 14, extra: { 's2-2': 24, 's2-4': 24, 's2-5': 36, 's2-6': 40, 's2-7': 10, 's2-8': 20, 's2-9': 120, 's2-10': 34, 's2-11': 30, 's2-13': 30, 's2-14': 30 } });
